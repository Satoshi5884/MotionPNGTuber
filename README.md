...
| 日付 | 内容 |
|------|------|
| 2026/01/11 | **GPU/CPU選択機能**と**音声ファイル入力機能**を追加。RTX 5060 Tiなど新しいGPUでもCPUモードで動作可能に。音声ファイルからの口パク生成にも対応しました。 |
...
- 🎵 **音声ファイル入力**: リアルタイムだけでなく、録音済み音声データからも口パク生成が可能
- 🤖 **AITuber対応**: 仮想オーディオデバイスを使えばAITuberのアバターとしても利用可能
- 🎭 **感情自動判定**: 音声から感情（喜び・怒り・悲しみ等）を推定し、表情を自動切替
- 💻 **GPU/CPU選択**: RTX 5060 TiなどPyTorch未対応GPUでもCPUモードで動作
